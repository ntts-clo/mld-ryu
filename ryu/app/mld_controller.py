...
class mld_controller(simple_switch_13.SimpleSwitch13, multiprocessing.Process):
    ...
    # send_to_mld
    # =========================================================================
    def send_to_mld(self, sendmsg):
        self.logger.debug("")

        # send of zeromq
        self.send_sock.send(cPickle.dumps(sendmsg, protocol=0))
