...
class test_flow_mod_genrator(unittest.TestCase):
    ...
    def test_initialize_flows_002(self):
        ...
        self.assertEquals(self.mfg[0].table_id, 0)
        self.assertEquals(self.mfg[0].priority, PRIORITY_NORMAL)
        self.assertEquals(self.mfg[0].match['in_port'], 3)
        self.assertEquals(self.mfg[0].match['eth_type'], ether.ETH_TYPE_IPV6)
        self.assertEquals(self.mfg[0].match['ip_proto'], inet.IPPROTO_ICMPV6)
        self.assertEquals(self.mfg[0].match['icmpv6_type'], icmpv6.MLD_LISTENER_QUERY)
        self.assertEquals(len(self.mfg[0].instructions), 1)
        ...
        self.assertEquals(self.mfg[1].table_id, 0)
        self.assertEquals(self.mfg[1].priority, PRIORITY_NORMAL)
        self.assertEquals(self.mfg[1].match['in_port'], 2)
        self.assertEquals(self.mfg[1].match['eth_type'], ether.ETH_TYPE_IPV6)
        self.assertEquals(self.mfg[1].match['ip_proto'], inet.IPPROTO_ICMPV6)
        self.assertEquals(self.mfg[1].match['icmpv6_type'], icmpv6.MLDV2_LISTENER_REPORT)
        self.assertEquals(len(self.mfg[1].instructions), 1)
        self.assertEquals(self.mfg[1].instructions[0].type, ofproto.OFPIT_APPLY_ACTIONS)
        self.assertEquals(len(self.mfg[1].instructions[0].actions), 1)
        self.assertEquals(self.mfg[1].instructions[0].actions[0].port, 3)
        ...
        self.assertEquals(self.mfg[2].instructions[0].actions[3].value, '00:00:00:00:00:00')
        self.assertEquals(self.mfg[2].instructions[0].actions[4].key, 'eth_src')
        self.assertEquals(self.mfg[2].instructions[0].actions[4].value, "00:00:00:00:00:04")
        self.assertEquals(self.mfg[2].instructions[0].actions[5].ethertype, ether.ETH_TYPE_8021AD)
        self.assertEquals(self.mfg[2].instructions[0].actions[6].key, 'vlan_vid')
        self.assertEquals(self.mfg[2].instructions[0].actions[6].value, bvid)
        self.assertEquals(self.mfg[2].instructions[0].actions[7].port, ofproto.OFPP_NORMAL)
        ...
        self.assertEquals(self.mfg[3].table_id, 4)
        self.assertEquals(self.mfg[3].priority, PRIORITY_NORMAL)
        self.assertEquals(self.mfg[3].match['in_port'], 0x02000000 | 60)
        self.assertEquals(self.mfg[3].match['vlan_vid'], ivid)
        self.assertEquals(len(self.mfg[3].instructions), 1)
        self.assertEquals(self.mfg[3].instructions[0].type, ofproto.OFPIT_APPLY_ACTIONS)
        self.assertEquals(len(self.mfg[3].instructions[0].actions), 1)
        ...
        self.assertEquals(self.mfg[4].table_id, 4)
        self.assertEquals(self.mfg[4].priority, PRIORITY_NORMAL)
        self.assertEquals(self.mfg[4].match['in_port'], 0x02000000 | 59)
        self.assertEquals(self.mfg[4].match['vlan_vid'], ivid)
        self.assertEquals(len(self.mfg[4].instructions), 1)
        self.assertEquals(self.mfg[4].instructions[0].type, ofproto.OFPIT_APPLY_ACTIONS)
        self.assertEquals(len(self.mfg[4].instructions[0].actions), 1)
    ...
    def test_start_mg_001(self):
        ...
        self.assertEquals(self.fmg[0].table_id, 4)
        self.assertEquals(self.fmg[0].priority, PRIORITY_NORMAL)
        self.assertEquals(self.fmg[0].match['in_port'], 0x02000000 | 51)
        self.assertEquals(self.fmg[0].match['vlan_vid'], ivid)
        ...
        self.assertEquals(len(self.fmg[0].instructions[0].actions), 1)
        self.assertEquals(self.fmg[0].instructions[0].actions[0].port, ofproto.OFPP_NORMAL)
        ...
        self.assertEquals(self.fmg[1].match['in_port'], apresia_12k.PBB2TAG)
        # PBBデカプセル時のBVIDは省略可
        self.assertEquals(self.fmg[1].match['eth_type'], ether.ETH_TYPE_8021AH)
        self.assertEquals(self.fmg[1].match['pbb_isid'], pbb_isid)
        self.assertEquals(self.fmg[1].match['eth_dst'], container_sw_bmac)
        ...
        self.assertEquals(len(self.fmg[1].instructions[0].actions), 5)
        ...
        self.assertEquals(self.fmg[1].instructions[0].actions[1].type, OFPActionPopPbb().type)
        self.assertEquals(self.fmg[1].instructions[0].actions[1].len, OFPActionPopPbb().len)
        self.assertEquals(self.fmg[1].instructions[0].actions[2].ethertype, ether.ETH_TYPE_8021Q)
        self.assertEquals(self.fmg[1].instructions[0].actions[3].key, 'vlan_vid')
        self.assertEquals(self.fmg[1].instructions[0].actions[3].value, ivid)
        self.assertEquals(self.fmg[1].instructions[0].actions[4].port, ofproto.OFPP_NORMAL)

        # table 4
        self.assertEquals(self.fmg[2].datapathid, datapathid)
        self.assertEquals(self.fmg[2].table_id, 4)
        self.assertEquals(self.fmg[2].priority, PRIORITY_LOW)
        self.assertEquals(self.fmg[2].match['in_port'], 0x00000000 | portno)
        ...
        # 以下、エッジSWのFlowMod
        # table 2
        self.assertEquals(self.fmg[3].datapathid, edge_datapathid)
        self.assertEquals(self.fmg[3].table_id, 2)
        self.assertEquals(self.fmg[3].priority, PRIORITY_NORMAL)
        self.assertEquals(self.fmg[3].match['in_port'], 2)
        self.assertEquals(self.fmg[3].match['eth_type'], ether.ETH_TYPE_IPV6)
        self.assertEquals(self.fmg[3].match['ipv6_dst'], multicast_address)
        ...
        self.assertEquals(len(self.fmg[3].instructions[0].actions), 2)
        self.assertEquals(self.fmg[3].instructions[0].actions[0].key, 'vlan_vid')
        self.assertEquals(self.fmg[3].instructions[0].actions[0].value, ivid)
        self.assertEquals(self.fmg[3].instructions[0].actions[1].port, ofproto.OFPP_NORMAL)

        # table 3
        self.assertEquals(self.fmg[4].datapathid, edge_datapathid)
        self.assertEquals(self.fmg[4].table_id, 3)
        self.assertEquals(self.fmg[4].priority, PRIORITY_NORMAL)
        self.assertEquals(self.fmg[4].match['in_port'], apresia_12k.TAG2PBB)
        self.assertEquals(self.fmg[4].match['vlan_vid'], ivid)
        ...
        self.assertEquals(len(self.fmg[4].instructions[0].actions), 8)
        ...
        self.assertEquals(self.fmg[4].instructions[0].actions[1].ethertype, ether.ETH_TYPE_8021AH)
        self.assertEquals(self.fmg[4].instructions[0].actions[2].key, 'pbb_isid')
        self.assertEquals(self.fmg[4].instructions[0].actions[2].value, pbb_isid)
        self.assertEquals(self.fmg[4].instructions[0].actions[3].key, 'eth_dst')
        self.assertEquals(self.fmg[4].instructions[0].actions[3].value, '00:00:00:00:00:00')
        self.assertEquals(self.fmg[4].instructions[0].actions[4].key, 'eth_src')
        self.assertEquals(self.fmg[4].instructions[0].actions[4].value, edge_sw_bmac)
        self.assertEquals(self.fmg[4].instructions[0].actions[5].ethertype, ether.ETH_TYPE_8021AD)
        self.assertEquals(self.fmg[4].instructions[0].actions[6].key, 'vlan_vid')
        self.assertEquals(self.fmg[4].instructions[0].actions[6].value, bvid)
        self.assertEquals(self.fmg[4].instructions[0].actions[7].port, ofproto.OFPP_NORMAL)

        # table 4
        self.assertEquals(self.fmg[5].datapathid, edge_datapathid)
        self.assertEquals(self.fmg[5].table_id, 4)
        self.assertEquals(self.fmg[5].priority, PRIORITY_NORMAL)
        self.assertEquals(self.fmg[5].match['in_port'], 0x02000000 | 49)
    ...
    def test_start_mg_002(self):
        ...
        self.assertEquals(self.fmg[0].table_id, 4)
        self.assertEquals(self.fmg[0].priority, PRIORITY_NORMAL)
        self.assertEquals(self.fmg[0].match['in_port'], 0x02000000 | 52)
        self.assertEquals(self.fmg[0].match['vlan_vid'], ivid)
        self.assertEquals(len(self.fmg[0].instructions), 1)
        self.assertEquals(self.fmg[0].instructions[0].type, ofproto.OFPIT_APPLY_ACTIONS)
        self.assertEquals(len(self.fmg[0].instructions[0].actions), 1)
        ...
        self.assertEquals(self.fmg[5].table_id, 4)
        self.assertEquals(self.fmg[5].priority, PRIORITY_NORMAL)
        self.assertEquals(self.fmg[5].match['in_port'], 0x02000000 | 50)
        self.assertEquals(self.fmg[5].match['vlan_vid'], ivid)
        self.assertEquals(len(self.fmg[5].instructions), 1)
        self.assertEquals(self.fmg[5].instructions[0].type, ofproto.OFPIT_APPLY_ACTIONS)
        self.assertEquals(len(self.fmg[5].instructions[0].actions), 1)
    ...
    def test_add_datapath_001(self):
        ...
        self.assertEquals(self.mfg[0].table_id, 4)
        self.assertEquals(self.mfg[0].priority, PRIORITY_NORMAL)
        self.assertEquals(self.mfg[0].match['in_port'], 0x02000000 | 51)
        self.assertEquals(self.mfg[0].match['vlan_vid'], ivid)
        self.assertEquals(len(self.mfg[0].instructions), 1)
        self.assertEquals(self.mfg[0].instructions[0].type, ofproto.OFPIT_APPLY_ACTIONS)
        self.assertEquals(len(self.mfg[0].instructions[0].actions), 1)
        ...
        # table 3
        self.assertEquals(self.mfg[1].datapathid, datapathid)
        self.assertEquals(self.mfg[1].table_id, 3)
        self.assertEquals(self.mfg[1].priority, PRIORITY_NORMAL)
        self.assertEquals(self.mfg[1].match['in_port'], apresia_12k.PBB2TAG)
        self.assertEquals(self.mfg[1].match['eth_type'], ether.ETH_TYPE_8021AH)
        self.assertEquals(self.mfg[1].match['pbb_isid'], pbb_isid)
        self.assertEquals(self.mfg[1].match['eth_dst'], container_sw_bmac)
        self.assertEquals(len(self.mfg[1].instructions), 1)
        self.assertEquals(self.mfg[1].instructions[0].type, ofproto.OFPIT_APPLY_ACTIONS)
        self.assertEquals(len(self.mfg[1].instructions[0].actions), 5)
        self.assertEquals(self.mfg[1].instructions[0].actions[0].type, OFPActionPopVlan().type)
        self.assertEquals(self.mfg[1].instructions[0].actions[0].len, OFPActionPopVlan().len)
        self.assertEquals(self.mfg[1].instructions[0].actions[1].type, OFPActionPopPbb().type)
        self.assertEquals(self.mfg[1].instructions[0].actions[1].len, OFPActionPopPbb().len)
        self.assertEquals(self.mfg[1].instructions[0].actions[2].ethertype, ether.ETH_TYPE_8021Q)
        self.assertEquals(self.mfg[1].instructions[0].actions[3].key, 'vlan_vid')
        self.assertEquals(self.mfg[1].instructions[0].actions[3].value, ivid)
        self.assertEquals(self.mfg[1].instructions[0].actions[4].port, ofproto.OFPP_NORMAL)

        # table 4
        self.assertEquals(self.mfg[2].datapathid, datapathid)
        self.assertEquals(self.mfg[2].table_id, 4)
        self.assertEquals(self.mfg[2].priority, PRIORITY_LOW)
        self.assertEquals(self.mfg[2].match['in_port'], 0x00000000 | portno)
        self.assertEquals(self.mfg[2].match['vlan_vid'], ivid)
        self.assertEquals(len(self.mfg[2].instructions), 1)
        self.assertEquals(self.mfg[2].instructions[0].type, ofproto.OFPIT_APPLY_ACTIONS)
        ...
        # 以下、エッジSW
        # table 3
        self.assertEquals(self.mfg[3].datapathid, edge_datapathid)
        self.assertEquals(self.mfg[3].table_id, 3)
        self.assertEquals(self.mfg[3].priority, PRIORITY_NORMAL)
        self.assertEquals(self.mfg[3].match['in_port'], apresia_12k.TAG2PBB)
        self.assertEquals(self.mfg[3].match['vlan_vid'], ivid)
        self.assertEquals(len(self.mfg[3].instructions), 1)
        self.assertEquals(self.mfg[3].instructions[0].type, ofproto.OFPIT_APPLY_ACTIONS)
        self.assertEquals(len(self.mfg[3].instructions[0].actions), 8)
        ...
        self.assertEquals(self.mfg[3].instructions[0].actions[1].ethertype, ether.ETH_TYPE_8021AH)
        self.assertEquals(self.mfg[3].instructions[0].actions[2].key, 'pbb_isid')
        self.assertEquals(self.mfg[3].instructions[0].actions[2].value, pbb_isid)
        self.assertEquals(self.mfg[3].instructions[0].actions[3].key, 'eth_dst')
        self.assertEquals(self.mfg[3].instructions[0].actions[3].value, '00:00:00:00:00:00')
        self.assertEquals(self.mfg[3].instructions[0].actions[4].key, 'eth_src')
        self.assertEquals(self.mfg[3].instructions[0].actions[4].value, edge_sw_bmac)
        self.assertEquals(self.mfg[3].instructions[0].actions[5].ethertype, ether.ETH_TYPE_8021AD)
        self.assertEquals(self.mfg[3].instructions[0].actions[6].key, 'vlan_vid')
        self.assertEquals(self.mfg[3].instructions[0].actions[6].value, bvid)
        self.assertEquals(self.mfg[3].instructions[0].actions[7].port, ofproto.OFPP_NORMAL)
        self.assertEquals(self.mfg[3].command, ofproto.OFPFC_MODIFY)

        # table 4
        self.assertEquals(self.mfg[4].datapathid, edge_datapathid)
        self.assertEquals(self.mfg[4].table_id, 4)
        self.assertEquals(self.mfg[4].priority, PRIORITY_NORMAL)
        self.assertEquals(self.mfg[4].match['in_port'], 0x02000000 | 49)
        self.assertEquals(self.mfg[4].match['vlan_vid'], ivid)
    ...
    def test_add_datapath_002(self):
        ...
        self.assertEquals(self.mfg[0].table_id, 4)
        self.assertEquals(self.mfg[0].priority, PRIORITY_NORMAL)
        self.assertEquals(self.mfg[0].match['in_port'], 0x02000000 | 52)
        self.assertEquals(self.mfg[0].match['vlan_vid'], ivid)
        self.assertEquals(len(self.mfg[0].instructions), 1)
        self.assertEquals(self.mfg[0].instructions[0].type, ofproto.OFPIT_APPLY_ACTIONS)
        self.assertEquals(len(self.mfg[0].instructions[0].actions), 1)
        ...
        self.assertEquals(self.mfg[4].table_id, 4)
        self.assertEquals(self.mfg[4].priority, PRIORITY_NORMAL)
        self.assertEquals(self.mfg[4].match['in_port'], 0x02000000 | 50)
        self.assertEquals(self.mfg[4].match['vlan_vid'], ivid)
        self.assertEquals(len(self.mfg[4].instructions), 1)
        self.assertEquals(self.mfg[4].instructions[0].type, ofproto.OFPIT_APPLY_ACTIONS)
        self.assertEquals(len(self.mfg[4].instructions[0].actions), 1)
    ...
    def test_remove_mg_001(self):
        ...
        self.assertEquals(len(self.mfg), 6)

        # 以下、エッジSW
        # table 2
        self.assertEquals(self.mfg[0].datapathid, edge_datapathid)
        self.assertEquals(self.mfg[0].table_id, 2)
        self.assertEquals(self.mfg[0].priority, PRIORITY_NORMAL)
        self.assertEquals(self.mfg[0].match['in_port'], 2)
        self.assertEquals(self.mfg[0].match['eth_type'], ether.ETH_TYPE_IPV6)
        self.assertEquals(self.mfg[0].match['ipv6_dst'], multicast_address)
        self.assertEquals(len(self.mfg[0].instructions), 0)
        self.assertEquals(self.mfg[0].command, ofproto.OFPFC_DELETE)
        self.assertEquals(self.mfg[0].out_port, ofproto.OFPP_ANY)
        self.assertEquals(self.mfg[0].out_group, ofproto.OFPG_ANY)

        # table 3
        self.assertEquals(self.mfg[1].datapathid, edge_datapathid)
        self.assertEquals(self.mfg[1].table_id, 3)
        self.assertEquals(self.mfg[1].priority, PRIORITY_NORMAL)
        self.assertEquals(self.mfg[1].match['in_port'], apresia_12k.TAG2PBB)
        self.assertEquals(self.mfg[1].match['vlan_vid'], ivid)
        self.assertEquals(len(self.mfg[1].instructions), 0)
        self.assertEquals(self.mfg[1].command, ofproto.OFPFC_DELETE)
        self.assertEquals(self.mfg[1].out_port, ofproto.OFPP_ANY)
        self.assertEquals(self.mfg[1].out_group, ofproto.OFPG_ANY)

        # table 4
        self.assertEquals(self.mfg[2].datapathid, edge_datapathid)
        self.assertEquals(self.mfg[2].table_id, 4)
        self.assertEquals(self.mfg[2].priority, PRIORITY_NORMAL)
        self.assertEquals(self.mfg[2].match['in_port'], 0x02000000 | 49)
        self.assertEquals(self.mfg[2].match['vlan_vid'], ivid)
        self.assertEquals(len(self.mfg[2].instructions), 0)
        self.assertEquals(self.mfg[2].command, ofproto.OFPFC_DELETE)
        self.assertEquals(self.mfg[2].out_port, ofproto.OFPP_ANY)
        self.assertEquals(self.mfg[2].out_group, ofproto.OFPG_ANY)
        ...
        self.assertEquals(self.mfg[3].table_id, 4)
        self.assertEquals(self.mfg[3].priority, PRIORITY_NORMAL)
        self.assertEquals(self.mfg[3].match['in_port'], 0x02000000 | 51)
        self.assertEquals(self.mfg[3].match['vlan_vid'], ivid)
        self.assertEquals(len(self.mfg[3].instructions), 0)
        self.assertEquals(self.mfg[3].command, ofproto.OFPFC_DELETE)
        self.assertEquals(self.mfg[3].out_port, ofproto.OFPP_ANY)
        self.assertEquals(self.mfg[3].out_group, ofproto.OFPG_ANY)

        # table 3
        self.assertEquals(self.mfg[4].datapathid, datapathid)
        self.assertEquals(self.mfg[4].table_id, 3)
        self.assertEquals(self.mfg[4].priority, PRIORITY_NORMAL)
        self.assertEquals(self.mfg[4].match['in_port'], apresia_12k.PBB2TAG)
        self.assertEquals(self.mfg[4].match['eth_type'], ether.ETH_TYPE_8021AH)
        self.assertEquals(self.mfg[4].match['eth_dst'], container_sw_bmac)
        self.assertEquals(len(self.mfg[4].instructions), 0)
        self.assertEquals(self.mfg[4].command, ofproto.OFPFC_DELETE)
        self.assertEquals(self.mfg[4].out_port, ofproto.OFPP_ANY)
        self.assertEquals(self.mfg[4].out_group, ofproto.OFPG_ANY)

        # table 4
        self.assertEquals(self.mfg[5].datapathid, datapathid)
        self.assertEquals(self.mfg[5].table_id, 4)
        self.assertEquals(self.mfg[5].priority, PRIORITY_LOW)
        self.assertEquals(self.mfg[5].match['in_port'], 0x00000000 | portno)
        self.assertEquals(self.mfg[5].match['vlan_vid'], ivid)
        self.assertEquals(len(self.mfg[5].instructions), 0)
        self.assertEquals(self.mfg[5].command, ofproto.OFPFC_DELETE)
        self.assertEquals(self.mfg[5].out_port, ofproto.OFPP_ANY)
        self.assertEquals(self.mfg[5].out_group, ofproto.OFPG_ANY)
    ...
    def test_remove_mg_002(self):
        ...
        self.assertEquals(self.mfg[3].table_id, 4)
        self.assertEquals(self.mfg[3].priority, PRIORITY_NORMAL)
        self.assertEquals(self.mfg[3].match['in_port'], 0x02000000 | 52)
        self.assertEquals(self.mfg[3].match['vlan_vid'], ivid)
        self.assertEquals(len(self.mfg[3].instructions), 0)
        self.assertEquals(self.mfg[3].command, ofproto.OFPFC_DELETE)
        self.assertEquals(self.mfg[3].out_port, ofproto.OFPP_ANY)
    ...
    def test_remove_port_001(self):
        ...
        self.assertEquals(self.mfg[0].table_id, 4)
        self.assertEquals(self.mfg[0].priority, PRIORITY_LOW)
        self.assertEquals(self.mfg[0].match['in_port'], 0x00000000 | portno)
        self.assertEquals(self.mfg[0].match['vlan_vid'], ivid)
        self.assertEquals(len(self.mfg[0].instructions), 0)
        self.assertEquals(self.mfg[0].command, ofproto.OFPFC_DELETE)
        self.assertEquals(self.mfg[0].out_port, ofproto.OFPP_ANY)
    ...
    def test_remove_datapath_001(self):
        ...
        self.assertEquals(self.mfg[0].command, ofproto.OFPFC_MODIFY)
    ...
    def test_remove_datapath_002(self):
        ...
        self.assertEquals(self.mfg[2].table_id, 4)
        self.assertEquals(self.mfg[2].priority, PRIORITY_NORMAL)
        self.assertEquals(self.mfg[2].match['in_port'], 0x02000000 | 52)
        self.assertEquals(self.mfg[2].match['vlan_vid'], ivid)
        self.assertEquals(len(self.mfg[2].instructions), 0)
        self.assertEquals(self.mfg[2].command, ofproto.OFPFC_DELETE)
        self.assertEquals(self.mfg[2].out_port, ofproto.OFPP_ANY)
    ...
    def test_initialize_flows_apresia_26k_001(self):
        ...
        try:
            ...
            self.assertEquals(e.value, 'Unsupported Operation')
            self.assertEquals(str(e), "'Unsupported Operation'")
            return
